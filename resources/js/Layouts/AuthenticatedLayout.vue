            ...
            <nav class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink :href="route('bovinos.index')" :active="route().current('bovinos.*')">
                                    Bovinos
                                </NavLink>
                                ...
                                <NavLink :href="route('eventos.index')" :active="route().current('eventos.*')">
                                    Eventos
                                </NavLink>
                            </div>
                        </div>
                ...
                >
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink :href="route('bovinos.index')" :active="route().current('bovinos.*')">
                            Bovinos
                        </ResponsiveNavLink>
                        ...
                        <ResponsiveNavLink :href="route('eventos.index')" :active="route().current('eventos.*')">
                            Eventos
                        </ResponsiveNavLink>
                    </div>
